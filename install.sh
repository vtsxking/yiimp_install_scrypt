#!/bin/bash
################################################################################
# Original Author:   crombiecrunch -> xavatar
# Modified by : vtsxking (https://github.com/vtsxking/yiimp_install_scrypt)
# Web: N/A    
#
# Program:
...
################################################################################
    ...
    # Compil Blocknotify
    cd ~
    hide_output git clone https://github.com/vtsxking/yiimp
